...
class RButton(context: Context, attrs: AttributeSet) extends Button(context, attrs) with ReactiveClicker

class RSeekbar(context: Context, attrs: AttributeSet) extends SeekBar(context, attrs) with ReactiveSeekbar

class RTextView(context: Context, attrs: AttributeSet) extends TextView(context, attrs) with ReactiveTextView

class REditText(context: Context, attrs: AttributeSet) extends EditText(context, attrs) with ReactiveEditText
